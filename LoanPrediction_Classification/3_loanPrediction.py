...
# 19. Fit the Logistics Regression model
lr = LogisticRegression()
# create the RFE model and select 8 important attributes
lr = RFE(lr, 8)
model = lr.fit(X_train, y_train)
predictions = lr.predict(X_validation)
print('Best 8 Features as per LR Algorithm:\n', lr.support_)
print('Ranking of the Features as per LR Algorithm:\n', lr.ranking_)
...
# 20a. Plot the line / model
plt.scatter(y_validation, predictions)
plt.xlabel('NB True Values')
plt.ylabel('NB Predictions')
plt.show()

# 20b. Test cross validation for LR and evaluation metric
seed = 7
scoring = 'accuracy'
...
# 20c. Plot the line / model
plt.scatter(y, predictions)
plt.xlabel('NB CV True Values')
plt.ylabel('NB CV Predictions')
plt.show()

# 21. Fit an Extra Boost Classifier model to the data
xgbc = XGBClassifier()
xgbc = RFE(xgbc, 8)
...
# 21a. Plot the XGBC model
plt.scatter(y_validation, predictions)
plt.xlabel('XGBC True Values')
plt.ylabel('XGBC Predictions')
plt.show()

# 21b. Test cross validation for XGBC algorithm
seed = 7
scoring = 'accuracy'
...
# 22a. Plot the line / model
plt.scatter(y_validation, predictions)
plt.xlabel('LDA True Values')
plt.ylabel('LDA Predictions')
plt.show()

# 22b. Test cross validation for LR and evaluation metric
seed = 7
scoring = 'accuracy'
