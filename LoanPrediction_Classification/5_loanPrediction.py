...
# 17. Apply Multiple Model Ensembling Using VotingClassifier
# 17a. create the sub models
estimators = []
...
# 17.b create the ensemble model
ensemble = VotingClassifier(estimators)
kfold = KFold(n_splits=10, random_state=seed)
scores = cross_val_score(ensemble, X, y, cv=kfold)
predictions = cross_val_predict(ensemble, X, y, cv=kfold)
print('VC Cross-Validated Scores:', scores.mean())
print('Cross Validated Accuracy Score of VC Algorithm: %.2f%%' % (accuracy_score(y, predictions) * 100.0))
print('Cross Validated Confusion Matrix of VC Algorithm:\n', confusion_matrix(y, predictions))
print('Cross Validated Classification Report of VC Algorithm:\n', classification_report(y, predictions))
